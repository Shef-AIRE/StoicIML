...
from pipeline._linear_beta import LinearTrainer, test
...
def  main():
    ...
    export_dir = f"{cfg.RESULT.OUTPUT_DIR}-{args.model}-intlabelprotein-seqlen{cfg.SEQ.MAX_LEN}-optimfold{cfg.CV.OPTIM_FOLD}"
    mkdir(export_dir)
