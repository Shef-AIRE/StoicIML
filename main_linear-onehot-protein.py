...
from pipeline._linear_beta_onehot_protein import LinearTrainer, test
...
def  main():
    ...
    export_dir = f"{cfg.RESULT.OUTPUT_DIR}-{args.model}-onehotprotein-seqlen{cfg.SEQ.MAX_LEN}-optimfold{cfg.CV.OPTIM_FOLD}"
    mkdir(export_dir)
