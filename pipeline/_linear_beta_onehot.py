...
from pipeline._dataloader import to_embedding_one_hot_cluster
...
class LinearTrainer:
    ...
    def objective(self, trial,
        ...
        for fold, (idx_train, idx_val) in enumerate(TrainValSplit.split()):
            ...
            train_index, train_x, train_y = to_embedding_one_hot_cluster(df_train, max_length)
            val_index, val_x, val_y = to_embedding_one_hot_cluster(df_val, max_length)
...
def test(framework=None,
    ...
    # ---- setup test dataset ----
    train_index, train_x, train_y = to_embedding_one_hot_cluster(df_train, max_length)
    test_index, test_x, test_y = to_embedding_one_hot_cluster(df_test, max_length)
