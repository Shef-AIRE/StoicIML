...
from pipeline._dataloader import to_embedding_one_hot_protein_selected
...
class LinearTrainer:
    ...
    def objective(self, trial,
        ...
        for fold, (idx_train, idx_val) in enumerate(TrainValSplit.split()):
            ...
            train_index, train_x, train_y = to_embedding_one_hot_protein_selected(df_train, max_length, select_index)
            val_index, val_x, val_y = to_embedding_one_hot_protein_selected(df_val, max_length, select_index)
...
def test(framework=None,
    ...
    # ---- setup test dataset ----
    train_index, train_x, train_y = to_embedding_one_hot_protein_selected(df_train, max_length, select_index)
    test_index, test_x, test_y = to_embedding_one_hot_protein_selected(df_test, max_length, select_index)
